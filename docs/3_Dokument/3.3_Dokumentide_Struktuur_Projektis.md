...
* **Projektiosad:** Mahukamad ehitusprojektid jaotatakse tavaliselt eriosadeks vastavalt projekteerimisvaldkondadele, nagu on kirjeldatud standardis [EVS 932:2017](https://www.evs.ee/et/evs-932-2017) §6.1. Elektripaigaldiste projekteerija jaoks on olulisemad osad tavaliselt:
    ...
    * **EL - Tugevvoolupaigaldised:** Hõlmab elektrivarustust elektriseadmetele, maandust, piksekaitset jne.
    * **EN - Nõrkvoolupaigaldised:** Hõlmab andmeside-, side-, turva- (valve, läbipääs, video), ATS- ja muid nõrkvoolusüsteeme.
    * **EAH - Hooneautomaatika:** Hõlmab hooneautomaatikat, tehnosüsteemide juhtimist jne.
    * **EAT - Tuleohutuse automaatika:** Hõlmab tuleohutussüsteemide automaatikat (Sprinkleri juhtimine, gaasikustutuse juhtimine, suitsueemalduse juhtimine jne).
    * Sõltuvalt projekti mahust ja meeskonna struktuurist võib elektriprojekt olla esitatud ühe tervikliku osana (nt "Elektripaigaldis") või jaotatud alamemadeks (EL, EN, EAH, EAT). Oluline on säilitada sisemine loogika ja järjepidevus.
...
* Tiitelleht peab sisaldama vähemalt järgmist informatsiooni (vastavalt määrusele "Nõuded ehitusprojektile" §7(1):
...
* **Struktuur:** Seletuskirja soovituslik struktuur (tuginedes näidisele lisas X [viide Grupp A mallile]):
    ...
    * **2. Tehnilised lahendused:** Detailne kirjeldus eriosade (EL, EN, EAH, EAT) kaupa, sh:
