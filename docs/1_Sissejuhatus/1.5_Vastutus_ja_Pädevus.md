...
|---|---|---|
| **Tugevvoolupaigaldise projekt** | Diplomeeritud elektriinsener, tase 7: ehitiste elektripaigaldised, projekteerimine VÕI elektriala A või B klassi pädevustunnistus | Diplomeeritud elektriinsener, tase 7: ehitiste elektripaigaldised, projekteerimine |
| **Nõrkvoolupaigaldise projekt** | Turvasüsteemide projekteerija, tase 6: ehitise teavitamissüsteemi, häireseadmestiku, jälgimisseadmestiku ja tulekahjusignalisatsioonisüsteemi projekteerimine | Turvasüsteemide projekteerija, tase 6: ehitise teavitamissüsteemi, häireseadmestiku, jälgimisseadmestiku ja tulekahjusignalisatsioonisüsteemi projekteerimine |
| **Tuleohutuse automaatika projekt** | Turvasüsteemide projekteerija, tase 6: tuleohutusautomaatika projekteerimine | Turvasüsteemide projekteerija, tase 6: tuleohutusautomaatika projekteerimine |
| **Hooneautomaatika projekt** | Diplomeeritud automaatikainsener, tase 7: ehitusautomaatika, projekteerimine | Diplomeeritud automaatikainsener, tase 7: ehitusautomaatika, projekteerimine |
