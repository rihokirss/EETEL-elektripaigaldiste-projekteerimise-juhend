...
* **Päikeseelektrijaama (PV) projekt** — paneelide paigutus, inverterite valik, tootlikkuse arvutused, kaitsesüsteemid ja võrguga liitumise tingimused. Ei kuulu elektriprojekteerija pädevusse. Elektriprojekteerija näitab üldskeemil PV-jaama ühenduskoha ja arvestab liitumispunkti mõjuga elektrivarustuse lahendusele (vt ptk 4.2).
...
* **Ehituse töömahtude loetelu koostamine**, sh ei sisalda paigalduskaablite koguseid.
* **Ehitushanke dokumentide koostamine** (nt pakkumustabel ja töövõtupiiride kirjeldused ehituse alltöövõtjatele).
* **Hooldus- ja kasutusjuhendite koostamine.**
* **Teostusdokumentatsiooni koostamine.**
* **Keskpinge kaabelliinide ja transiitkappide projekteerimine** ning võrguteenuse ettevõtjale vajalike välisvõrkude ümbertöstmine — vastavalt tehnilistele tingimustele teostab võrguteenuse ettevõtja.
