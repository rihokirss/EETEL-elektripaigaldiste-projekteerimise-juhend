...
* **Päikeseelektrijaama (PV) projekt** — paneelide paigutus, inverterite valik, tootlikkuse arvutused, kaitsesüsteemid ja võrguga liitumise tingimused. Ei kuulu elektriprojekteerija pädevusse. Elektriprojekteerija näitab üldskeemil PV-jaama ühenduskoha ja arvestab liitumispunkti mõjuga elektrivarustuse lahendusele (vt ptk 4.2). Koostab eraldi ettevõte spetsiaaltarkvaraga.
