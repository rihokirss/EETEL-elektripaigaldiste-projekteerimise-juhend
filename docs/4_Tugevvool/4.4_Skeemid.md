...
Üldnõuded skeemidele on käsitletud peatükis [4.2 Üldnõuded ja standardid](4.2_Yldnouded_ja_standardid.md).

## 4.4.1 Elektrivarustuse skeem
...
## 4.4.3 Sisevalgustuse juhtimisskeemid
...
<figure markdown="span">
  ![DALI struktuurskeemi näidis](../_assets/media/4-4_DALI_struktuurskeem.png)
  <figcaption>Joonis 2. DALI valgustuse juhtimissüsteemi struktuurskeemi näidis</figcaption>
</figure>

## 4.4.4 Välisvalgustuse skeem
...
<figure markdown="span">
  ...
  <figcaption>Joonis 3. Välisvalgustuse skeemi näidis</figcaption>
</figure>

## 4.4.5 Evakuatsioonivalgustuse skeem — sisseehitatud akud ja monitooring
...
<figure markdown="span">
  ![Evakuatsioonivalgustuse skeem sisseehitatud akudega](../_assets/media/4-2_Evak_valg_skeem.png)
  <figcaption>Joonis 4. Evakuatsioonivalgustuse monitooringu skeemi näidis</figcaption>
</figure>

## 4.4.6 Evakuatsioonivalgustuse skeem — keskakusüsteem

* **Eesmärk:** Anda ülevaade evakuatsioonivalgustuse keskakusüsteemi põhimõttest.
* **Skeemil näidatakse (PP/TP staadiumis):**
    * Evakuatsioonivalgustite kaabelduse põhimõte.
    * Valgusti kogused korruste ja hooneosade lõikes.
    * Keskseade ja sellest väljuvad kanalid ning valgustite arvud.
    * Korruste jaotuskeskustes paiknevad pingekontrollireleed, mis on ühendatud keskakuseadme andmesidesiinile (lahendus võib sõltuvalt keskakuseadme tüübist veidi erineda).

<figure markdown="span">
  ![Evakuatsioonivalgustuse skeem keskakuseadmega](../_assets/media/4-4_Evak_valg_keskaku.png)
  <figcaption>Joonis 5. Evakuatsioonivalgustuse struktuurskeemi näidis keskakusüsteemiga</figcaption>
</figure>

## 4.4.7 Hooneväliste elektriseadmete skeem
...
<figure markdown="span">
  ...
  <figcaption>Joonis 6. Hooneväliste elektriseadmete skeemi näidis</figcaption>
</figure>

## 4.4.8 Potentsiaaliühtlustuse skeem
...
## 4.4.9 Laia maandussüsteemi skeem
...
<figure markdown="span">
  ...
  <figcaption>Joonis 7. Arvestite skeemi näidis</figcaption>
</figure>

## 4.4.12 Elektriautode laadimise skeem
...
<figure markdown="span">
  ...
  <figcaption>Joonis 8. Elektriautode laadimise skeemi näidis</figcaption>
</figure>
