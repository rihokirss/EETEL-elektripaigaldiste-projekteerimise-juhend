...
#### 4.3.3.1 Primaarskeemid (ühejooneskeemid)
...
#### 4.3.3.2 Sekundaarahelate skeemid
...
#### 4.3.3.3 RLA loogika skeem (vajadusel)
...
| **PP (Põhiprojekt)** | • Kõik EP mahus esitatu, täpsustatuna<br>• Jaotuskeskuste nõuetelehed<br>• Peajaotuskeskuse ühejooneskeem<br>• Garanteeritud ja katkematu toite jaotuskeskuste ühejooneskeemid<br>• Vajadusel muud skeemid (nt RLA loogika skeem)<br>• Installatsioonimaterjalide spetsifikatsioonid (sh kilpide osas) |
| **TP (Tööprojekt)** | • Kõik PP mahus esitatu, täpsustatuna ja detailiseerituna<br>• Jaotuskeskuste nõuetelehed täpsustatud andmetega valmistajalt<br>• Lõplikud primaarskeemid koos kõikide seadmete täpsete parameetrite ja sätetega<br>• RLA loogika skeem<br>• Komponentide spetsifikatsioonid (tüüp, nominaal, valmistaja kood, tehnilised parameetrid)
