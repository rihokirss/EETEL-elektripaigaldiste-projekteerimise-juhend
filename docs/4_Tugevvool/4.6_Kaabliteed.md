...
* **Kaabliteed:** Iga kaablitee lõik (eriti riputatav) peab olema varustatud viitega/tähisega, mis sisaldab vähemalt:
    ...
    * **Süsteem:** EL (tugevvool), EN (nõrkvool), TK (tulekindlad kaabliteed) — võib olla ka värvi/mustriga.
...
* Kaabliteede planeerimisel arvestada teiste tehnosüsteemide (KVJVK, vesi-kanal) paiknemisega ja ruumivajadusega. Koostöö teiste projekti osade projekteerijatega on kriitilise tähtsusega.
