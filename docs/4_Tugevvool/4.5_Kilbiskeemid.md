# 4.5 Jaotuskeskused (sh nõueteleht, skeemid, laotised)
...
Üldnõuded jaotuskeskustele on käsitletud peatükis [4.2 Üldnõuded ja standardid](4.2_Yldnouded_ja_standardid.md).

## 4.5.1 Jaotuskeskuse nõueteleht
...
## 4.5.2 Primaarskeemid (ühejooneskeemid)
...
## 4.5.3 Sekundaarahelate skeemid
...
!!! info "Lisatellimus"
    Sekundaarahelate skeemide koostamine ei kuulu standardsesse elektriprojekteerimise töömahtu ning üldjuhul koostab kilbi valmistaja. Sekundaarskeemide mahtu on võimalik hinnata peale tööprojekti valmimist ja tarnitavate seadmete valikut.
    ...
    **Sekundaarahelate skeemide sisendandmed:**
    ...
    - Tarnitavad KVJ ja VK seadmed ja süsteemid (ehitaja)
...
Skeemi võib esitleda eraldi skeemina, kus on välja toodud vaid RLA-ga ja blokeeringutega seotud lülituste osa, või osana teisest skeemist, näiteks magistraalliinide skeemil.
...
## 4.5.5 Keskpinge jaotusseadme skeem

Keskpinge jaotusseadme skeem esitatakse vajadusel, kui projektis käsitletakse keskpinge (KP) jaotussüsteemi (nt alajaama või liitumispunktiga seotud keskpinge lülitusseadmeid). Sisu ja detailsusaste täpsustatakse vastavalt projekti eripärale ja staadiumile.

## 4.5.6 Jaotuskeskuste laotised (Layout)
