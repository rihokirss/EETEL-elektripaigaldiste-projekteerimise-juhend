...
### 4.5.3. Evakuatsioonivalgustuse toited ja juhtimine

* **Standard:** [EVS-EN 1838](https://www.evs.ee/et/evs-en-1838-2013). Arvestada tuleohutusosa projektis määratletud nõuetega.
* **PP staadiumis:**
    * Hädavalgustuse struktuurskeemid (kesktoite-/monitooringusüsteemi ülesehitus, liinide jaotus)
    * Kesktoitesüsteemi skeemid (keskaku, liinide koormused)
    * Keskakusüsteemi (CBS) või detsentraliseeritud akusüsteemide paiknemine ja ühendused
...
### 4.5.5. Dokumentatsiooni esitamine staadiumiti
