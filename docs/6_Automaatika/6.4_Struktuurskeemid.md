...
<figure markdown="span">
  ...
  <figcaption>Joonis 6.4.3. Arvestite struktuurskeemi näidis põhiprojekti staadiumis</figcaption>
</figure>
...
<figure markdown="span">
  ...
  <figcaption>Joonis 6.4.4. Arvestite struktuurskeemi näidis tööprojekti staadiumis</figcaption>
</figure>
...
<figure markdown="span">
  ...
  <figcaption>Joonis 6.4.5. Ventilatsiooniseadme funktsionaalskeemi näidis põhiprojekti staadiumis (ilma tehaseautomaatikata)</figcaption>
</figure>
...
<figure markdown="span">
  ...
  <figcaption>Näide 1. Jahutuse fancoil + kütteradiaator</figcaption>
</figure>

<figure markdown="span">
  ![Kliima PP paneelid](../_assets/media/6-4_Kliima_PP_paneelid.jpg)
  <figcaption>Näide 2. Lae kütte-/jahutuspaneelid + VAV</figcaption>
</figure>

<figure markdown="span">
  ![Kliima PP split](../_assets/media/6-4_Kliima_PP_split.jpg)
  <figcaption>Näide 3. Split-seadmed</figcaption>
</figure>
...
* **TP (Tööprojekti Staadium):**
    ...
    * Sidumise I/O maht (visualiseeritavate punktide juhtimise ja jälgimise maht koos kirjeldusega).
    * (Näide? - joonis xxx).
